...
# REVISION HISTORY
#------------------------------------------------------------------------------
# Refer to the vSecPrim_rules.mak file.
###############################################################################
...
VSECPRIM_CORE_PATH      = vSecPrim\
VSECPRIM_OUTPUT_PATH    = $(GENDATA_DIR)
...
#------------------------------------------------------------------------------------------
CC_INCLUDE_PATH     += vSecPrim$(BSW_SRC_DIR)
CPP_INCLUDE_PATH    +=
ASM_INCLUDE_PATH    +=
