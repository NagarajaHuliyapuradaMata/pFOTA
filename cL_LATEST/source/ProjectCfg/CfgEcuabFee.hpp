...
typedef P2FUNC(Std_ReturnType, ECUABFEE_PRIVATE_CODE, EcuabFee_ReadPtrType)(Fls_AddressType FlsAddress, P2CONST(uint8, AUTOMATIC, FLS_APPL_CONST) TargetAddressPtr, Fls_LengthType Length);
