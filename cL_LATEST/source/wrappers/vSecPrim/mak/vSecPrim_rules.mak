...
#------------------------------------------------------------------------------
# 1.00.00   2018-17-10  visrpp  Created
# 1.01.00   2019-02-06  vircbl  Added support of component-based SIP structure
# 1.01.01   2019-03-18  vismwe  Changed slash to backslash
#------------------------------------------------------------------------------
...
LIBRARIES_TO_BUILD      += vSecPrim
vSecPrim_FILES             = vSecPrim$(BSW_SRC_DIR)\*.c

# e.g.: CC_FILES_TO_BUILD       += drv\can_drv.c
ifeq ($(GET_IMPLEMENTION_FROM), LIB)
CC_FILES_TO_BUILD       +=
else
CC_FILES_TO_BUILD       +=  vSecPrim$(BSW_SRC_DIR)\*.c
